  ...
  return (
    <section id="home" className="relative pt-32 pb-24 md:pt-48 md:pb-32 px-6 overflow-hidden flex flex-col items-center justify-center text-center min-h-[90vh]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        ...
        >
          Cresça Naturalmente, <br className="hidden md:block" />
          <span className="text-primary relative inline-block">
            Viva Sustentavelmente
        ...
        >
          Descubra nossa linha de produtos orgânicos cuidadosamente selecionados, criados com profundo respeito por você e pelo planeta que compartilhamos. Experimente o melhor da natureza.
        </motion.p>
